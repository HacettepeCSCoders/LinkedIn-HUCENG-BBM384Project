...
public class GraduateService {
    ...
    public Optional<Graduate> getByUsername(String username) {
        return Optional.ofNullable(graduateRepository.findByUsername(username).orElseThrow(IllegalStateException::new));
    }
